...
function scaffold(
  ...
  writeFileSync(resolve(root, 'shell', 'src', 'main.tsx'), shellMain({ scope, moduleName, importName }))
  writeFileSync(resolve(root, 'shell', 'src', 'stores', 'auth.ts'), shellAuthStore({ scope }))
  writeFileSync(resolve(root, 'shell', 'src', 'stores', 'config.ts'), shellConfigStore({ scope, appName: projectName }))
  ...
  writeFileSync(resolve(root, 'shell', 'src', 'components', 'Sidebar.tsx'), shellSidebar({ projectName }))
